...
const vgMatWater = new THREE.MeshStandardMaterial({ color: 0x2f5560, roughness: 0.2, metalness: 0.1, transparent: true, opacity: 0.7, envMap: envRT.texture, envMapIntensity: 0.9 });
